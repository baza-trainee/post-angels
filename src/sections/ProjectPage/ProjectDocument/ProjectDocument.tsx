...
import {
  ProjectDataInfoProps,
  ProjectDocumentProps,
  ProjectOneDataProps,
  ProjectOneDataType,
  StaticDataProps,
} from '../ProjectPage.props';
...
export const ProjectDocument = ({
  ...
  projectInfoData: ProjectOneDataProps;

  project_details: StaticDataProps;
}) => {
  const projectDataDoc = projectInfoData?.projects?.attributes?.document;
  const projectSupportsData = projectInfoData.supportsData;
  return (
