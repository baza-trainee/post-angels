            ...
            <div>
              ...
              <div className="mb-[30px] flex items-center gap-x-[10px] xl:mb-[20px]">
                <CustomImage
                  ...
                  alt={data.organizer.image.alt || 'background image'}
                  width={data?.organizer?.image?.src?.data?.attributes?.width || 200}
                  height={data?.organizer?.image?.src?.data?.attributes?.height || 150}
                  defaultImg="/images/default_img/organize.png"
