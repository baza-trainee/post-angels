...
export const ScrollBtn: FC<ScrollBtnProps> = ({ data }) => {
  ...
  return (
    <Scroll
      ...
      } fixed bottom-[300px] right-0 flex h-[62px] w-[21px] items-center justify-center rounded bg-transparent transition-opacity duration-300 md:right-[calc((100vw_-_768px)_*_0.5)] lg:right-[calc((100vw_-_1000px)_*_0.5)] xl:right-[calc((100vw_-_1245px)_*_0.5)] 2xl:right-[calc((100vw_-_1406px)_*_0.5)] 3xl:right-[calc((100vw_-_1886px)_*_0.5)]`}
    >
