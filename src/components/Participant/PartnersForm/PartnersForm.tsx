...
export const PartnersForm: React.FC<PartnersFormProps> = ({
  ...
  return (
    <FormProvider {...methods}>
      ...
      >
        <div className="relative flex flex-col flex-nowrap content-between gap-x-[172px] gap-y-8  border-t-[1px] border-t-grey-60 pt-10  lg:h-[613px] lg:flex-wrap lg:gap-x-0 2xl:h-[608px] 3xl:h-[620px]">
