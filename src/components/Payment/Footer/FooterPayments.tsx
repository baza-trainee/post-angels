...
const FooterPayments: React.FC = () => {
  ...
  return (
    <div className=' hover:[&>*]:text-accent-hover focus:[&>*]:text-accent-hover sm:hidden xs:hidden md:flex md:mt-[50px] px-[100px]'>
         <ul
                  className={`mb-[50px] mt-[30px] flex  justify-between xl:flex-nowrap md:px-[100px] px-[150px] xl:px-[60px]  3xl:pl-[100px]`}
                >
                  <li className="flex w-[148px] items-center justify-center pb-[30px] pr-[9px] sm:w-2/4  group-hover:text-accent-primary group-focus:text-accent-primary group-hover:fill-accent-primary group-focus:fill-accent-primary md:mr-[80px] lg:mr-[100px] xl:mr-[200px] mr-[150px] 2xl:px-[100px]">
                  ...
                  <li className="flex h-[22px] w-[148px] items-center justify-center sm:w-2/4  group-hover:text-accent-primary group-focus:text-accent-primary group-hover:fill-accent-primary group-focus:fill-accent-primary md:mr-[80px] mr-[150px] lg:mr-[100px] xl:mr-[200px] 2xl:mr-[100px]">
                  ...
                  <li className="flex h-[22px] w-[150px] items-center justify-center pr-[10px] sm:w-2/4  group-hover:text-accent-primary group-focus:text-accent-primary group-hover:fill-accent-primary group-focus:fill-accent-primary md:mr-[80px] mr-[150px] lg:mr-[100px] xl:mr-[200px] 2xl:px-[100px]">
