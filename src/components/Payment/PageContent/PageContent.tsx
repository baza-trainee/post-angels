...
const PageContent = ({ payments, schema }: { payments: Payments; schema: SchemaTypes }) => {
  ...
  className={`relative w-full rounded-2xl border-2 py-[14px] mb-[30px] transition-all duration-500 hover:border-accent-primary hover:text-accent-primary focus:border-accent-primary focus:text-accent-primary xl:border-none xl:text-accent-primary xl:underline-offset-2 hover:xl:underline focus:xl:underline ${
...
<button
  ...
  className={` relative w-full mb-[30px]  rounded-2xl border-2 py-[14px] transition-all duration-500 hover:border-accent-primary  hover:text-accent-primary  focus:border-accent-primary focus:text-accent-primary  xl:border-none xl:text-accent-primary xl:underline-offset-2 hover:xl:underline focus:xl:underline ${
...
>
  {MonthlyTextButton}
        ...
        {less1280px && activeButton === 'OneTime' && <OneTimeAssistanceForm isDisabled={false} payments={payments}
            schema={schema} className='xl:mr-[73px] xl:flex xl:w-1/2 2xl:mr-[73px] 3xl:mr-[93px]'/>}
      </div>

      {less1280px && activeButton === 'Monthly' && <MonthlyAssistanceForm isDisabled={false} payments={payments} schema={schema} className='flex xl:w-1/2  active:xl:border-accent-primary'/>}
