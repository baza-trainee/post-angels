...
const BankIcons: React.FC = () => {
    const beforeClass = `before:block before:w-[1px] before:h-[12%] before:bg-grey-60 before:absolute before:top-[796px] before:left-[50%] sm:before:block sm:before:w-[1px] sm:before:h-[12%] sm:before:bg-grey-60 sm:before:absolute sm:before:top-[758px] sm:before:left-[52%] md:before:block md:before:w-[1px] md:before:h-[116px] md:before:bg-grey-60 md:before:absolute md:before:top-[738px] md:before:left-[52%] xl:before:h-0 xl:before:w-0`;
    const afterClass = `after:block after:w-[320px] xl:after:w-[1px] after:h-[1px]  after:bg-grey-60 after:absolute after:left-[0px] after:top-[858px] xl:after:top-0 sm:after:block sm:after:w-[90%] sm:after:h-[1px] sm:after:bg-grey-60 sm:after:absolute sm:after:left-[14px] sm:after:top-[806px] md:after:top-[784px] md:after:left-[38px] xl:after:w-0 xl:after:h-0`;
