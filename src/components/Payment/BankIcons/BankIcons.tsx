...
const BankIcons: React.FC = () => {
    const beforeClass = `before:block before:w-[1px] before:h-[15%] before:bg-grey-60 before:absolute before:top-[710px] before:left-[50%] sm:before:block sm:before:w-[1px] sm:before:h-[15%] sm:before:bg-grey-60 sm:before:absolute sm:before:top-[670px] sm:before:left-[52%] md:before:block md:before:w-[1px] md:before:h-[116px] md:before:bg-grey-60 md:before:absolute md:before:top-[652px] md:before:left-[52%] xl:before:h-0 xl:before:w-0`;
