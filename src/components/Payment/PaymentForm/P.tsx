    ...
    <form className={className}>
      <div className="mt-7 flex w-full flex-col gap-y-8">
        {/* <div className="flex flex-col justify-between gap-y-3 text-center uppercase lg:flex-row lg:gap-x-10">
          {dictionaryData.subscriptionOptions.map((option: any) => (
        ...
        <Select
          ...
          placeholder={dictionaryData.currencyPlaceholder}
        />
        ...
        <div className="flex w-full flex-col gap-x-3 gap-y-[10px] md:flex-row md:flex-wrap md:justify-center">
          {dotaionOptions.map(amount => (
            <label className="flex cursor-pointer items-center gap-x-2" key={amount}>
              ...
              />
              <div
                className={`w-full rounded-[32px] border py-[14px] text-center text-accent-primary hover:border-accent-primary focus:border-accent-primary md:w-[200px] ${
      ...
      <div className="flex w-full flex-col gap-x-3 gap-y-[10px] md:flex-row md:justify-center">
        <div className="relative">
          <input
            type="number"
            placeholder={dictionaryData.amountPlaceholder}
        ...
        <Button
          ...
          // aria-label={dictionaryData.button.label}
          onClick={handelClick}
          disabled={!(selectedCurrency && donationAmount) ?? true}
        >
          {/* {dictionaryData.button.title} */}1
        </Button>
      </div>
    </form>
  );
